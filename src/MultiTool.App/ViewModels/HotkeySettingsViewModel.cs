...
public partial class HotkeySettingsViewModel : ObservableObject
{
    ...
    public HotkeySettingsViewModel(HotkeySettings currentSettings)
    {
        ...
        isModifierVariantsEnabled = workingCopy.AllowModifierVariants;
    }
    ...
    [ObservableProperty]
    private bool isModifierVariantsEnabled = true;
    ...
    private void Reset()
    {
        ...
        IsModifierVariantsEnabled = true;
        RefreshDisplays();
    }
    ...
    partial void OnIsModifierVariantsEnabledChanged(bool value)
    {
