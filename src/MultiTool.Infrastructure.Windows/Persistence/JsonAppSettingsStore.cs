...
namespace MultiTool.Infrastructure.Windows.Persistence;
...
public sealed class JsonAppSettingsStore : IAppSettingsStore
{
    ...
    private static AppSettings NormalizeSettings(AppSettings settings)
    {
        ...
        settings.Clicker.RandomTimingVarianceMilliseconds = Math.Max(settings.Clicker.RandomTimingVarianceMilliseconds, 0);
