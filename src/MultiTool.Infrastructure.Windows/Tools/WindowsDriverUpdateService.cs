...
public sealed class WindowsDriverUpdateService : IDriverUpdateService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IReadOnlyList<DriverHardwareInfo> hardware = hardwareInventory ?? [];
        IReadOnlyList<DriverUpdateCandidate> updates = [];

        if (hardwareInventory is null)
        {
            try
            {
    ...
    internal static IReadOnlyList<DriverHardwareInfo> ReadHardwareInventory()
    {
