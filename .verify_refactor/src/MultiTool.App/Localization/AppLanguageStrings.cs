...
public static class AppLanguageKeys
{
    ...
    public const string HotkeySettingsModifierVariantsLabel = "HotkeySettingsModifierVariantsLabel";
...
public static class AppLanguageStrings
{
    private static readonly Dictionary<string, (string English, string CatSpeak)> Values = new(StringComparer.Ordinal)
    {
        ...
        [AppLanguageKeys.ClickerForceStopHelperText] = (
        ...
        [AppLanguageKeys.MainRandomTimingLabel] = ("Random timing", "Random timing"),
        [AppLanguageKeys.MainRandomTimingVarianceLabel] = ("Variation (+/- ms)", "Variation (+/- ms)"),
        [AppLanguageKeys.MainRandomTimingHelperText] = ("Each click varies around the base interval by up to this many milliseconds.", "Each click varies around the base interval by up to this many milliseconds."),
        ...
        [AppLanguageKeys.MainMacroInfiniteLabel] = ("Infinite", "Infinite"),
        [AppLanguageKeys.MainMacroInfiniteHelperFormat] = ("With Infinite on, press {0} again to stop the macro.", "With Infinite on, press {0} again to stop the macro."),
        ...
        [AppLanguageKeys.MainSettingsStatusRunAtStartupOn] = ("Run at startup is on.", "Run at startup is on."),
        [AppLanguageKeys.MainSettingsStatusRunAtStartupOff] = ("Run at startup is off.", "Run at startup is off."),
        [AppLanguageKeys.MainSettingsStatusRunAtStartupFailedFormat] = ("Unable to change run at startup: {0}", "Could not change run at startup: {0}"),
        [AppLanguageKeys.MainActivityRunAtStartupEnabled] = ("Enabled run at startup.", "Enabled run at startup."),
        [AppLanguageKeys.MainActivityRunAtStartupDisabled] = ("Disabled run at startup.", "Disabled run at startup."),
        ...
        [AppLanguageKeys.MainMacroStatusAlreadyPlaying] = ("A macro is already playing.", "A macro is already playing."),
        [AppLanguageKeys.MainMacroStatusPlayingFormat] = ("Playing '{0}' x{1}.", "Playing '{0}' x{1}."),
        [AppLanguageKeys.MainMacroStatusPlayingInfiniteFormat] = ("Playing '{0}' infinitely. Press {1} again to stop.", "Playing '{0}' infinitely. Press {1} again to stop."),
        [AppLanguageKeys.MainMacroStatusStoppedInfiniteFormat] = ("Stopped infinite playback for '{0}'.", "Stopped infinite playback for '{0}'."),
        ...
        [AppLanguageKeys.HotkeySettingsModifierVariantsLabel] = (
        ...
        [AppLanguageKeys.ShortcutExplorerFilterSourceSuffixFormat] = (
            ...
            ". {0} detected from this PC, {1} built-in or common references"),
        [AppLanguageKeys.ShortcutExplorerStatusReady] = (
            "Shortcut results loaded. Use Rescan to refresh them.",
            "Shortcut results loaded. Use Rescan to refresh them."),
        [AppLanguageKeys.ShortcutExplorerStatusCachedResults] = (
            "Showing the last found shortcut results. Use Rescan to refresh them.",
            "Showing the last found shortcut results. Use Rescan to refresh them."),
        [AppLanguageKeys.ShortcutExplorerStatusRescanning] = (
        ...
        [AppLanguageKeys.ShortcutExplorerStatusRescannedFormat] = (
            ...
            "Shortcut list refreshed with {0} detected shortcut{1} and {2} built-in/common reference entr{3}."),
        [AppLanguageKeys.ShortcutExplorerStatusRescanFailedFormat] = (
        ...
        [AppLanguageKeys.ShortcutExplorerStatusDisableSkippedUnsupportedSuffixFormat] = (
            ...
            " Skipped {0} unsupported entr{1}."),
        [AppLanguageKeys.ShortcutExplorerStatusDisableNoChangesFormat] = (
            "No shortcut hotkeys were disabled.{0}",
            "No shortcut hotkeys were disabled.{0}"),
        [AppLanguageKeys.ShortcutExplorerStatusDisableUnsupportedFormat] = (
            "The selected entries can't be disabled from here yet. Only detected Windows shortcut files are supported.{0}",
            "The selected entries can't be disabled from here yet. Only detected Windows shortcut files are supported.{0}"),
        [AppLanguageKeys.ShortcutExplorerStatusDisableWarningsSuffixFormat] = (
            " Skipped {0} shortcut change{1}.",
            " Skipped {0} shortcut change{1}."),
        [AppLanguageKeys.ShortcutExplorerStatusDisableFailedFormat] = (
        ...
        [AppLanguageKeys.InstallerStatusInstalledScanDeferredFormat] = ("{0} installed. Update scan pending until you use Check All Updates.", "{0} installed. Update scan pending until you use Check All Updates."),
        ...
        [AppLanguageKeys.InstallerSelectionSummaryPendingUpdatesFormat] = ("{0} selected  |  {1} installed  |  updates not scanned yet", "{0} selected  |  {1} installed  |  updates not scanned yet"),
        ...
        [AppLanguageKeys.ToolsStatusShortcutDisableNoChangesFormat] = ("No Windows shortcut-file hotkeys were disabled.{0}", "No Windows shortcut-file hotkeys were disabled.{0}"),
        [AppLanguageKeys.ToolsStatusShortcutDisableUnsupportedFormat] = ("The selected shortcut entries can't be disabled from here yet. Only detected Windows shortcut files are supported.{0}", "The selected shortcut entries can't be disabled from here yet. Only detected Windows shortcut files are supported.{0}"),
        [AppLanguageKeys.ToolsStatusShortcutDisableFailedFormat] = ("Shortcut disable failed: {0}", "Shortcut disable failed: {0}"),
        ...
        [AppLanguageKeys.ToolsStatusTelemetryIpv4SourcesChangedFormat] = ("The live IPv4 snapshot went from {0} remote source{1} to {2} remote source{3}.", "The live IPv4 snapshot went from {0} remote source{1} to {2} remote source{3}."),
        [AppLanguageKeys.ToolsStatusTelemetryIpv4SourcesUnchangedFormat] = ("The live IPv4 snapshot stayed at {0} remote source{1}.", "The live IPv4 snapshot stayed at {0} remote source{1}."),
        [AppLanguageKeys.ToolsStatusTelemetryIpv4SourcesUnavailable] = ("Live IPv4 source comparison was unavailable.", "Live IPv4 source comparison was unavailable."),
