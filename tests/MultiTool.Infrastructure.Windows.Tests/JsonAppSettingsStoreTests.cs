...
public sealed class JsonAppSettingsStoreTests : IDisposable
{
    ...
    [Fact]
    public async Task SaveAsync_AndLoadAsync_ShouldRoundTripRandomTimingSettings()
    {
        Directory.CreateDirectory(workingDirectory);
        ...
        var expected = new AppSettings
        {
            Clicker = new ClickSettings
            {
                ...
                RandomTimingVarianceMilliseconds = 30,
            },
            Hotkeys = new HotkeySettings(),
        };
        ...
        actual.Clicker.Milliseconds.Should().Be(75);
        actual.Clicker.IsRandomTimingEnabled.Should().BeTrue();
        actual.Clicker.RandomTimingVarianceMilliseconds.Should().Be(30);
    }
    ...
    [Fact]
    public async Task SaveAsync_AndLoadAsync_ShouldRoundTripRunAtStartupSetting()
    {
        Directory.CreateDirectory(workingDirectory);
        ...
        actual.Ui.RunAtStartup.Should().BeTrue();
        actual.Ui.AutoHideOnStartup.Should().BeTrue();
    }
